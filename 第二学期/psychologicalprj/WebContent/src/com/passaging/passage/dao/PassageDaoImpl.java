package com.passaging.passage.dao;
...
public class PassageDaoImpl {
	 ...
	 * @return
	 */
	public List<Evaluate> selectEvaluateList(int articleId) {
		Session session = this.sessionFactory.getCurrentSession();
	 ...
	 * @return
	 */
	public List<Evaluate> selectEvaluateListByPage(int pageNum, int pageSize, int articleId) {
		Session session = this.sessionFactory.getCurrentSession();
