...
public class LoginWeiboService {
	...
	private Logger logger = Logger.getLogger(LoginWeiboService.class);
	 ...
	 * @return:int
	 *             <ul>
	 *             <li>若拉取微博资料成功，且登录成功，返回用户id</li>
	 *             <li>否则，返回-1</li>
	 *             </ul>
	 * @trhows
	 */
	public com.entity.User login(String accessToken, String weiboUid) {
		int userId = 0;
	 ...
	 * @trhows
	 */
	private void setInfo(com.entity.User user, com.psychologicalcounseling.login.weibo4j.model.User weiboUser) {
		// 用户昵称
