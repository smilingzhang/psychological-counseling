...
public class UpdateCourseRecordController {
	...
	public void updateCourseRecord(@RequestParam(value = "crid") String crid, @RequestParam(value = "time") String time,
			@RequestParam(value = "totaltime") String totaltime, HttpSession session) {
		// 将三个参数转为int类型
