...
public class CourseIntrController {
	...
	private Logger logger = Logger.getLogger(CourseIntrController.class);

	@RequestMapping("/course-intr")
	public String getCourseIntr(@RequestParam("courseId") int courseId, HttpServletRequest request,
		...
		logger.info("课程名：" + course.getCourseName() + "价格：" + course.getCoursePrice() + "ifbc:" + b + "user:"
				+ course.getTeacher().getUser().getUserNickName());
		// return "course-instr";
		int num = 1;
		// 查page=1的评论
