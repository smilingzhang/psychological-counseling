...
import com.indexing.dao.TeacherDaoImpl;
...
public class TeacherServiceImpl {
	...
	public List<Teacher> listConsulterByTypeAndPage(String typetableName){
		return teacherDaoImpl.findConsulterByTypeAndPage(typetableName);
	}

	
	public List<Teacher> listCanListenerByPage(){
		return teacherDaoImpl.findCanListenerByPage();
	}
	public List<Teacher> listConsulterByPage(){
		return teacherDaoImpl.findConsulterByPage();
	}
