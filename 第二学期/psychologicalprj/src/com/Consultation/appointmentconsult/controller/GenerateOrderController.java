...
public class GenerateOrderController extends GenerateRandomUtil {
	...
	public String generateOrder(@RequestParam(value = "teacherId", required = false) String teacherId,
			@RequestParam(value = "date", required = false) String date,
			@RequestParam(value = "content", required = false) String content,
			@RequestParam(value = "teacherPrice", required = false) String teacherPrice,
			@RequestParam(value = "type", required = false) String consultType, HttpServletRequest request,
