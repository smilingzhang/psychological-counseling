...
public class ConsultOrderService {
	 ...
	 * @trhows
	 */
	public int generateConsultOrder(int userId, int teacherId, String date, String teacherPrice, String content,
			String consultType) {
	...
	//得到咨询师的头像路径
	public String getImg(String teacherId) {
		int id=Integer.parseInt(teacherId);
		return this.consultOrderTeacherDao.selectTeacherImg(id);
	}
