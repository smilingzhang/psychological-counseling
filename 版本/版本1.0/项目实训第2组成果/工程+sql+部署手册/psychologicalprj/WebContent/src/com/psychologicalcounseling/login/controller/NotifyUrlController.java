...
public class NotifyUrlController {
	...
	public String aa(HttpServletRequest request, HttpServletResponse response)
		...
		logger.info(courseId + "20:4033333333333333333");
		...
		if (verify_result) {// 验证成功
			...
			if (trade_status.equals("TRADE_FINISHED")) {
				...
				if (alipayTradeQueryResponse.getTotalAmount().equals(total_amount)) {
					logger.info("恭喜你，已经跳到了这个阶段了");
					asi.insertCourseOrderByPrecreate(Integer.parseInt(courseId), Integer.parseInt(userId), out_trade_no,
