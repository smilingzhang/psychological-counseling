...
public class Teacher {
	...
	private String teacherAuthentication;
	...
	public String getTeacherAuthentication() {
		return teacherAuthentication;
	}
	public void setTeacherAuthentication(String teacherAuthentication) {
		this.teacherAuthentication = teacherAuthentication;
	}
	public String getTeacherGoodAt() {
		return teacherGoodAt;
	}
	public void setTeacherGoodAt(String teacherGoodAt) {
		this.teacherGoodAt = teacherGoodAt;
	}
