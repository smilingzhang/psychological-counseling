...
public class AppointmentController {
	...
	public String showConsultTime(@RequestParam("teacherName") String teacherName,@RequestParam("price") String teacherPrice,
			@RequestParam("date")String date,@RequestParam("autograph")String autograph,@RequestParam("id")String teacherId,
