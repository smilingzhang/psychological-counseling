...
public class ListenOrderDao extends BaseDao<ListenRecord>{
	...
	public void updateListenState(int listenOrderId) {
		...
		Query query=session.createSQLQuery("update listenrecord set listenrecordState=?,listenState=?,listenrecordStartTime=?,listenrecordEndTime=? where listenrecordId=?");
