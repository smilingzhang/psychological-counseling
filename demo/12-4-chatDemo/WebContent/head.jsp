...
<body>
		...
		<nav class="navbar contianer">
			<div class="container">
				<input type="checkbox" id="nav-toggle" class="nav-toggle" /> <label
					for="nav-toggle"> <span class="menu-icon"> <svg
							viewBox="0 0 18 15" width="18px" height="15px">
                            <path fill="white"
	...
	<c:if test="${sessionScope.user eq null}">
    		sessionScope.user eq null<br>
	</c:if>

	<c:if test="${sessionScope.user != null}">
    		sessionScope.user != null<br>
	</c:if>

	<a id="tips" href="room.jsp">咨询时间到！</a>
	<p>${sessionScope }</p>
