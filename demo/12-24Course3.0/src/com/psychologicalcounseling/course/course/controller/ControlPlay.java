...
public class ControlPlay {
	...
	public String controlPlay(@RequestParam(name="courseCatalogId") int logId,@RequestParam(name="startPosition")int startPosition,@RequestParam(name="courseId") int courseId,@RequestParam(name="ifbc") int ifbc,HttpServletRequest request,HttpServletResponse response) {
		...
		if(course.getCoursePrice()==0||(ifbc==1)) {
			ifplay=true;
		}
