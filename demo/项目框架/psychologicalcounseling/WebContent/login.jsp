            ...
            <div class="panel-body">
                ...
                <c:if test="${param.type=='login' }">
	                ...
	                <form class="login-form" action="${ctx }/login/login4Pwd" method="POST" id="second">
	                    <font name="loginErrMsg4Phone" id="loginErrMsg4Phone" class=""></font>
	                    <%--登录时需要显示是否为新用户 --%>
	                    <font name="loginErrMsg4Phone1" id="loginErrMsg4Phone1" class=""></font>
                    	<div><input name="phoneNum" type="text" class="form-control" id="phoneNum" placeholder="11位手机号" onblur="loginVerifyPhone();"></div><br/>
	                    <!-- 错误信息 -->							
