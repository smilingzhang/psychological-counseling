...
public class ConsultationRecord {
	...
	public String toString() {
		return "ConsultationRecord [consultationrecordOrderTime=" + consultationrecordOrderTime
				+ ", consultationrecordStartTime=" + consultationrecordStartTime + ", consultationrecordEndTime="
				+ consultationrecordEndTime + ", consultationrecordState=" + consultationrecordState + ", consultState="
				+ consultState + ", teacher=" + teacher + ", user=" + user + ", randomNum=" + randomNum + "]";
	}
