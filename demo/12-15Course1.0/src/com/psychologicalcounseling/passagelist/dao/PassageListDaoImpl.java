...
public class PassageListDaoImpl {
	 ...
	 * @return
	 */
	public TypeTable find(int typetableId) {                           
	 ...
	 * @return
	 */
	public List<BusinessType> list(int businesstypeWorkType,TypeTable typeTable){
		Session session = this.sessionFactory.getCurrentSession();
	 ...
	 * @return
	 */
	public Article find1(int businesstypeWorkId){
		Session session = this.sessionFactory.getCurrentSession();
