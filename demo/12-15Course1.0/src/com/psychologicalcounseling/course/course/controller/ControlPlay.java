...
public class ControlPlay {
	...
	public String controlPlay(@RequestParam(name="courseCatalogId") int logId,@RequestParam(name="startPosition")int startPosition,@RequestParam(name="courseId") int courseId,@RequestParam(name="ifbc") Boolean ifbc,HttpServletRequest request,HttpServletResponse response) {
