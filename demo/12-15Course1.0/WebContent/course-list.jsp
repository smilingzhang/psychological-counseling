            ...
            <div class="carousel">
                <div id="myNiceCarousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        ...
                        <a href="../course-intr?courseId=${freelesson[0].courseId}&userId=${userId}"><img style="width:1500px;height:250px;" alt="First slide" src="../${freelesson[0].courseImgPath }">
                        ...
                        <div class="item">
                        <a href="../course-intr?courseId=${freelesson[1].courseId}&userId=${userId}"><img style="width:1500px;height:250px;" alt="First slide" src="../${freelesson[1].courseImgPath }">
                        <div class="carousel-caption">
                        ...
                        <div class="item">
                        <a href="../course-intr?courseId=${freelesson[2].courseId}&userId=${userId}"><img style="width:1500px;height:250px;" alt="First slide" src="../${freelesson[2].courseImgPath }">
                        <div class="carousel-caption">
            ...
            <div class="recommend-2nd">
              ...
              <c:forEach items="${toplesson}" var="lesson">
                <div class="recommend-course panel">
                    ...
                    <!--课程图片-->
                        <img src="../${lesson.courseImgPath }" alt="推荐课程"/>
                        <!--课程名-->
                        <a href="../course-intr?courseId=${lesson.courseId}&userId=${userId}" class="course-name">${lesson.courseName }</a><br/>
                        <!--主讲人：跳转到讲师个人主页-->
                        <a href="teacher" class="teacher">${lesson.teacher.user.userRealName }</a>
                        <!--价格-->
        ...
        <div class="course-list-dir panel">
            <div class="panel-body" id="fg">
                 <span class="tag">分类</span>
                  <a class="types"  onclick="searchType(this);" type="0" style="color:blue;font-size:20px;">综合</a>
            ...
            <div class="panel-body" id="ajax">
              ...
              <c:forEach items="${endlesson.list }" var="lesson">
                <div class="course-block">
                    <!--课程图片-->
                    <img src="../${lesson.courseImgPath }" alt="${lesson.courseName }">
                    <!--课程名-->
                    <a class="title-h2" href="../course-intr?courseId=${lesson.courseId}&userId=${userId}">${lesson.courseName }</a><br/>
                    <!--一句话简介-->
                    <span class="tag">${lesson.courseSynopsis }</span><br/>
                    <!--主讲人-->
                    <a class="teacher" href="?teacherid=${leson.teacher.teacherId }">${lesson.teacher.user.userRealName }</a>
                    <!--价格-->
 			    ...
 			    if (xmlhttp.readyState==4 && xmlhttp.status==200){
 			        ...
 			        for(var i = 0;i < courses.length;i++){
 	    		    	...
 	    		    	html += '<div class="course-block"><img src="../'+courses[i].courseImgPath+ '" alt="课程图片">'+
 	    		    	        '<a class="title-h2" href="../course-intr?courseId='+courses[i].courseId+'&userId=${userId}">'+courses[i].courseName+'</a><br/>'+
 	    		    	        '<span class="tag">'+courses[i].courseSynopsis+'</span><br/>'+
 	    	                    '<a class="teacher" href="">'+keys[i].userRealName+'</a>'+
