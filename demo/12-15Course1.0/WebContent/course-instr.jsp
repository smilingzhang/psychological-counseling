                   	    ...
                   	    <c:when test="${myprice==0.0}">
                    		<c:if test="${ifbc==true}">
                    			...
                    			<form action="${ctx }/joinstudy" method="post">
                    			    ...
                    			    <input name="ifbc" value="${ifbc}" style="display:none;">
                    		...
                    		<c:if test="${ifbc==false}">
                      			...
                      			<form action="${ctx }/collect" method="post">
                       			...
                       			<form action="${ctx }/joinstudy?userId=${userId}&courseId=${course.courseId }&ifbc=${ifbc}" method="post">
                ...
                <div class="comment-part"  id="directory-contain-3" style="display:none">
                    ...
                    <div class="comment-block">
                        ...
                        <script type="text/javascript">
                            ...
                            var htmls = "<div class='pager-div' id='firesun'><ul class='pager'><li class='previous' id='pagePre'><a href='javascript:void(0)' onclick='showLeftComment(this)'>«</a></li>";
                        	var html = "";
	                        ...
	                        xmlhttp.open("get","${ctx}/lesson/logincomment?evaluateContent="+content+"&&courseid=${course.courseId}",true);
	               	        xmlhttp.send(); 
            ...
            <div class="right-part panel">
                <div class="panel-body">
                    ...
                    <div class="recomment-course">
                        ...
                        <!--主讲人姓名-->
                        <a href="consulter" class="teacher">${cou.teacher.user.userRealName }</a>
                    </div>
                    </c:forEach>
