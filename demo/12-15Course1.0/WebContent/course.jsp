                ...
                <div id="directory-contain-2" class="directory-contain" style="display:none">
                   ...
                   <c:forEach items="${aboutcourse }" var="temp">
                    <div class="recomment-course">
                        ...
                        <!--主讲人姓名-->
                        <span class="teacher">${temp.teacher.user.userRealName }</span>
                    </div>
                   </c:forEach>
                </div>
            </div>
        ...
        <div class="comment-input" id="comment-input">
            ...
            <script type="text/javascript">
                ...
                $("#submit").click(function(){
		            ...
		            xmlhttp.open("get","${ctx}/lesson/logincomment?evaluateContent="+content+"&&courseid=${catalog[0].courseId}",true);
		  	        xmlhttp.send(); 
		 		      ...
		 		      if (xmlhttp.readyState==4 && xmlhttp.status==200){
				        ...
				        for(var i=1;i<=totalPageNum&&i<=4;i++){
		 		    	...
		 		    	for(var i = 0;i<pages.length;i++){
					    	...
					    	htmls += "<li class='next' id='pageNext'><a pagenum='5' href='javascript:void(0)' onclick='showRightComment(this);'>»</a></ul></div>";
