...
public class ListenRecord {
	private Integer listenrecordId;
	...
	private Integer listenrecordState;
	...
	public Integer getListenrecordId() {
		return listenrecordId;
	}
	public void setListenrecordId(Integer listenrecordId) {
	...
	public String getListenrecordState() {
		return listenrecordState.toString();
	}
	public void setListenrecordState(String listenrecordState) {
		this.listenrecordState = Integer.valueOf(listenrecordState);
	}
