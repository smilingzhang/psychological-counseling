...
<link href="${ctx }/css/invite.css" rel="stylesheet">
</head>
		...
		<div id="myNiceCarousel" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner">
				<div class="item active">
					<img alt="First slide" src="${ctx }/images/banner-index.png">
				...
				<div class="item">
					<img alt="Second slide" src="${ctx }/images/banner-index-1.png">
					<div class="carousel-caption">
						<h3></h3>
						<p></p>
					</div>
				...
				<div class="item">
					<img alt="Third slide" src="${ctx }/images/banner-index-3.jpg">
					<div class="carousel-caption">
						<h3></h3>
						<p></p>
					</div>
