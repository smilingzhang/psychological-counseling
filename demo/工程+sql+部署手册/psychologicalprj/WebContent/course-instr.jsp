...
<jsp lang="zh-cn">
  <head>
    ...
    <title>课程_${course.courseName}</title>
    <!-- zui -->
        ...
        <div class="class-instr panel">
           <div class="panel-body">
                ...
                <div class="course-brief-instr">
                    ...
                    <!--主讲人名字-->
                    <br/>
                    <a class="teacher" href="${ctx }/consultdetail/showdetail?teacherId=${course.teacher.teacherId}">主讲人:${course.teacher.user.userRealName}</a><br/>
                    <!--课程价格-->
