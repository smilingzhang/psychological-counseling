            ...
            <div class="carousel">
                <div id="myNiceCarousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        ...
                        <a href="${ctx }/course-intr?courseId=<jm:encrypt>${freelesson[0].courseId}</jm:encrypt>"><img style="width:1500px;height:250px;" alt="First slide" src="${ctx }/images/banner-course-1.jpg">
                        ...
                        <div class="item">
                        <a href="${ctx }/course-intr?courseId=<jm:encrypt>${freelesson[1].courseId}</jm:encrypt>"><img style="width:1500px;height:250px;" alt="First slide" src="${ctx }/images/banner-course-2.jpg">
                        <div class="carousel-caption">
                            <h3 style="color:blue;"></h3>
                            <p style="color:red;"></p>
                        </div></a>
                        ...
                        <div class="item">
                        <a href="${ctx }/course-intr?courseId=<jm:encrypt>${freelesson[2].courseId}</jm:encrypt>"><img style="width:1500px;height:250px;" alt="First slide" src="${ctx }/images/banner-course-3.png">
                        <div class="carousel-caption">
                            <h3 style="color:blue;"></h3>
                            <p style="color:red;"></p>
                        </div></a>
            ...
            <div class="panel-body" id="ajax">
              ...
              <c:forEach items="${endlesson.list }" var="lesson">
                <div class="course-block">
                    ...
                    <!--主讲人-->
                    <a class="teacher" href="${ctx }/consultdetail/showdetail?teacherId=${lesson.teacher.user.userId}">${lesson.teacher.user.userRealName }</a>
                    <!--价格-->
