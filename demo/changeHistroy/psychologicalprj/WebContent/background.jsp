    ...
    <div id="background-contain">
        ...
        <div class="bg-contain" id="bg-contain">
            ...
            <div id="page-1" class="page">
                <h2>欢迎，<font id="userName" value="${user.userRealName }">${user.userRealName }</font></h2>
                <hr>
                ...
                <div class="board">
 				...
 				<div class="board">
                    ...
                    <div id = "monthly-volume" class="panel" frameborder="0" style="height:340px">
                        <div class="panel-body" >
                        	<h3>“及时倾听”业务用户单日访问量月统计</h3>
                            <!-- 下拉框 -->
                            <select id="months" data-options="required:true,editable:true" style="border: 1px solid #ccc;" onchange="changemonth()">
							...
							<!-- 【月份】日历图 -->
                            <div id="main_1" class="monthly-volume" style="width:580px;height:350px;"></div>
                        </div>
                    </div>
                    	<script type="text/javascript">
